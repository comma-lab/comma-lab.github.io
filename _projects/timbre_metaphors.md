...
*Editor's note: some text has been taken from a summary of the work published [elsewhere](https://timbreandorchestration.org/writings/project-reports/timbre-semantic-associations).* 
...
<img src="/assets/img/projects/mus_percept_means.png" alt="mean ratings for two example scales" width="750"/>
